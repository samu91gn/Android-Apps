...
//Gestione delle cadute: per creare, ottenere cadute � necessario usare un'istanza di questa classe
...
public class FallDataSource {
	...
	public static class Fall {
		...
		//PUBBLICO; RITORNA FALL VUOTA PER ADAPTER. FALL NON VALIDA
		public Fall(){
			isValid=false;
		}
	...
	//INSERISCE UNA NUOVA CADUTA DATA UNA SESSIONE E UNA LISTA DI ACQUISIZIONI
	...
	//RITORNA TUTTE LE ACQUISIZIONI DI UNA CADUTA
	...
	//SETTA SE LA CADUTA E' STATA NOTIFICATA O NO
