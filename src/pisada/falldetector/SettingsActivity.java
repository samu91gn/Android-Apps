...
/**
 * settings-activity: implementa una speciale interfaccia in landscape su cellulare,
 * sia in landscape sia in portrait su tablet. (derivada da activity standard Android SDK)
 */
...
public class SettingsActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener{
	...
	public static class SimplePreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			timeout = findPreference("max_duration_session");
			timeout.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {

				@Override
				public boolean onPreferenceChange(Preference preference, Object newValue) {
					int newValueInt = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(preference.getContext()).getString("max_duration_session", "60"))*60*1000;

					try{
						newValueInt = Integer.parseInt((String)newValue)*60*1000;
					}catch(NumberFormatException e){
						Toast.makeText(preference.getContext(), getResources().getString(R.string.toobig), Toast.LENGTH_SHORT).show();
						return false;
					}
					ForegroundService.TIMEOUT_SESSION = newValueInt;
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
		...
		else if(key.equals("time"))
		{
			...
			try {
				...
				//nel caso non ce ne siano, meglio fallire silenziosamente
			}
