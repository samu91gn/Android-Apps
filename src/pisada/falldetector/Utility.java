...
public class Utility {
	...
	public static Bitmap createImage(int sessionNumber){
		...
		//se è primo, otterrei un solo poligono. Per evitare questo, disegno sopra anche l'icona di sessionnumber+15 (pari, non primo), scalato di 0,66
	...
	private static ArrayList<int[]> getPrimesList(int sessionNumber){
		...
		for(Entry e: mapp){ //cerco nella "mappa"
		 ...
		 //Non è mai stato calcolato:calcolo la fattorizzazione e la inserisco nella mappa per accessi futuri
		if(!keyFound){
...
//Gestione fattorizzazioni già calcolate almeno una volta
